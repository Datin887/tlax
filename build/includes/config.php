...
// Название трека (TIT2) подставляется из формы админки автоматически.
...
define('ID3_COMMENT', 'Хитовая Песня — песни на заказ. Сделаем такую же для твоего праздника: tlax.ru'); // COMM — видно в плеерах, реклама при шеринге
